...
const experiences = [
  {
    ...
    company: "某科技公司",
    period: "2022 - 至今",
    description: "负责公司核心产品的前端架构设计和开发，使用 React、Next.js 构建高性能 Web 应用。",
    icon: "💼",
  ...
  },
  {
    ...
    company: "某创业公司",
    period: "2020 - 2022",
    description: "参与多个项目的全栈开发，独立负责前端架构和后端 API 设计。",
    icon: "🚀",
  ...
  },
  {
    ...
    company: "某互联网公司",
    period: "2019 - 2020",
    description: "负责公司官网和内部系统的开发与维护，积累扎实的开发经验。",
    icon: "🌱",
...
const services = [
  {
    icon: "💻",
    title: "Web 开发",
    description: "为企业和个人提供专业的 Web 应用开发服务，包括前端开发、后端架构设计等。",
    gradient: "from-blue-500 to-indigo-600",
  },
  {
    icon: "🎨",
    title: "UI/UX 设计",
    description: "提供用户界面设计和用户体验优化服务，打造美观易用的产品。",
    gradient: "from-pink-500 to-rose-600",
  },
  {
    icon: "⚡",
    title: "技术咨询",
    description: "为初创公司和技术团队提供技术选型、架构设计等方面的专业建议。",
        ...
        <div className="space-y-20">
            ...
            <div className="space-y-6 text-center md:text-left">
              <div>
                <h1 className="text-4xl font-bold">
                  关于<span className="bg-gradient-to-r from-indigo-500 via-purple-500 to-pink-500 bg-clip-text text-transparent">我</span>
                </h1>
              ...
              <p className="text-zinc-600 dark:text-zinc-400 leading-relaxed max-w-2xl">
                ...
                在过去的几年里，我积累了丰富的项目经验，擅长使用现代技术栈解决复杂的技术挑战。
                我相信好的代码应该是简洁、可维护的，用户体验应该是直观的。
              </p>
          ...
          <section className="space-y-8">
            <div className="text-center">
              ...
              <p className="text-zinc-600 dark:text-zinc-400 mt-2">我的职业历程</p>
            </div>
                    ...
                    <div className="p-6 flex-1">
                      <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4 mb-4">
                        <div className="flex items-center gap-4">
                          <div className={`w-12 h-12 rounded-xl bg-gradient-to-br ${exp.gradient} flex items-center justify-center text-2xl`}>
                            {exp.icon}
                          </div>
                          <div>
          ...
          <section className="space-y-8">
            <div className="text-center">
              ...
              <p className="text-zinc-600 dark:text-zinc-400 mt-2">我的学习经历</p>
            </div>
            <div className="grid gap-6 md:grid-cols-2 max-w-2xl mx-auto">
              {educations.map((edu, index) => (
                <Card
                  ...
                  style={{ animationDelay: `${index * 100}ms` }}
                >
                  <div className={`h-32 bg-gradient-to-br ${edu.gradient} flex items-center justify-center`}>
                  ...
                  <div className="p-6 text-center bg-white dark:bg-zinc-900">
                    ...
                    <p className="text-sm text-zinc-500 dark:text-zinc-400 mt-2">{edu.period}</p>
                  </div>
                </Card>
              ))}
            </div>
          ...
          <section className="space-y-8">
            <div className="text-center">
              ...
              <p className="text-zinc-600 dark:text-zinc-400 mt-2">专业服务，为你创造价值</p>
            </div>
          ...
          <section className="relative rounded-3xl overflow-hidden">
            ...
            <div className="relative text-center py-16 px-8">
              <h2 className="text-2xl font-bold text-white mb-4">有想法？让我帮你实现！</h2>
              <p className="text-white/80 mb-6 max-w-xl mx-auto">
                无论是网站开发、技术咨询还是其他需求，我都愿意倾听并提供专业的解决方案。
              </p>
