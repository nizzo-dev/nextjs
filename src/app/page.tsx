...
const stats = [
  { value: "3+", label: "年开发经验", color: "text-indigo-500", gradient: "from-indigo-500 to-purple-500" },
  { value: "20+", label: "完成项目", color: "text-pink-500", gradient: "from-pink-500 to-rose-500" },
  { value: "10+", label: "技术栈", color: "text-cyan-500", gradient: "from-cyan-500 to-blue-500" },
];
...
const featuredProjects = [
  {
    id: 1,
    title: "AI 助手应用",
    description: "基于大语言模型的智能助手，支持多轮对话和代码生成",
    emoji: "🤖",
  ...
  },
  {
    id: 2,
    title: "电商平台",
    description: "完整的电商解决方案，包含支付和订单管理",
    emoji: "🛒",
  ...
  },
  {
    id: 3,
    title: "视频会议",
    description: "实时视频会议，支持屏幕共享和白板协作",
    emoji: "📹",
        ...
        <div className="space-y-24">
          ...
          <section className="flex flex-col items-center text-center space-y-8 relative">
            ...
            <div className="relative">
              ...
              {/* 装饰点 */}
              <div className="absolute -top-2 -left-2 w-4 h-4 bg-pink-500 rounded-full animate-pulse-soft" style={{ animationDelay: "0.5s" }} />
              <div className="absolute top-4 -right-4 w-3 h-3 bg-cyan-500 rounded-full animate-pulse-soft" style={{ animationDelay: "1s" }} />
            </div>

            <div className="space-y-4 relative">
              <h1 className="text-4xl md:text-6xl font-bold tracking-tight">
                你好，我是 <span className="animate-gradient-text bg-clip-text text-transparent bg-gradient-to-r from-indigo-500 via-purple-500 to-pink-500">{PERSONAL_INFO.name}</span>
              </h1>
              <p className="text-xl text-zinc-600 dark:text-zinc-400 max-w-2xl mx-auto animate-fade-in-up">
                <span className="font-semibold text-indigo-500">{PERSONAL_INFO.title}</span>
            ...
            <div className="flex flex-wrap gap-4 justify-center animate-fade-in-up animate-delay-200">
              <Link href={ROUTES.projects}>
                <Button size="lg" className="bg-gradient-to-r from-indigo-500 to-purple-500 hover:from-indigo-600 hover:to-purple-600 hover-shine border-0">
                  查看作品
                </Button>
              </Link>
              <Link href={ROUTES.contact}>
                <Button variant="outline" size="lg" className="hover-shine border-indigo-500 text-indigo-500 hover:bg-indigo-50 dark:hover:bg-indigo-950">
                  联系我
                </Button>
              </Link>
            </div>
          ...
          <section className="space-y-8">
            <div className="text-center">
              ...
              <p className="text-zinc-600 dark:text-zinc-400 mt-2">我常用的技术</p>
            </div>
          ...
          <section className="space-y-8">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-zinc-600 dark:text-zinc-400 mt-2">最近的工作成果</p>
              </div>
              <Link href={ROUTES.projects}>
            ...
            <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
              {featuredProjects.map((project, index) => (
                <Link key={project.id} href={ROUTES.projects}>
          ...
          <section className="relative rounded-3xl overflow-hidden">
            ...
            <div className="relative text-center py-16 px-8">
              ...
              <p className="text-white/80 max-w-xl mx-auto mb-8">
                无论你是想构建一个网站、开发一个应用，还是需要技术咨询，我都很乐意帮忙。
              </p>
              <Link href={ROUTES.contact}>
